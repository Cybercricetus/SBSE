...
实验发现: 算法1, 2效果较差且过早收敛. 算法4的表现在默认配置下(100; 1/n_reqs)劣于算法3, 也有过早收敛的趋势. 在增加算法4的pop_size至300后, 虽然依旧弱于算法3但有所改善. pop_size增加至600后表现再次下降. 在增加算法4的mut_prob至5/n_reqs后, 即使采用较小的pop_size (=100)其表现也与算法3相近或优于算法3.
